...
confir = Button (tela, text = 'confirma', bg = 'green', fg = 'white', width = 6, height = 2, command = confirmar)
confir.place(x = 30, y = 300)

n0 = Button (tela, width = 4, height = 2, text = '0', command = lambda : votar(n0))
n0.place(x = 90, y = 300)

delete = Button (tela, text = 'corrigir', fg = 'white', bg = 'red', width = 6, height = 2, command = remover)
delete.place(x = 136, y = 300)
